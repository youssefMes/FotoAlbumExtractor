...
%% es soll ja im wesentlichen eher eine Ausarbeitung zum Thema sein: also Problemstellung/Ausprägung Input-Daten, Recherche/existierende Ansätze, eigner Lösungsansatz, auftretende Probleme/Iteration der Lösung, Testdaten/quantitative Evaluierung, Perspektive

%% also weniger eine Dokumentation, die Doku wäre eher ein Appendix oder im Repository neben Code und Test anzusiedeln, die Doku sollte dann die in/out Schnittstellen Parameter dokumentieren, die Codebestandteile können zur Ausarbeitung referenziert werden

%% 10 Seiten Ausarbeitung wäre gut

%% der Algorithmus sollte auch als Diagramm visualisiert werden und die einzelnen Bestandteile im Text mit Referenz auf Code besprochen werden

%% ihr habt ja von ca. 20 Freiheitsgraden gesprochen, diese sollten erläutert werden, Diskussion zukünftiger Ansätze/was wurde nicht untersucht
...
\input{chapters/hintergrundentfernung.tex}
\cleardoublepage

\input{chapters/rahmenentfernung.tex}
\cleardoublepage

\input{chapters/gesichtserkennung.tex}
\newpage

\input{chapters/evaluation.tex}
\cleardoublepage

\input{chapters/anleitung.tex}
\cleardoublepage
